...
class Polygon(slim_example_decoder.BoundingBox):
  ...
  def __init__(self, keys=None, prefix=None):
    ...
    """
    if keys is None:
      keys = ['y0', 'x0', 'y1', 'x1', 'y2', 'x2', 'y3', 'x3', 'y4', 'x4', 'y5', 'x5']
    elif len(keys) != 12:
      raise ValueError('Polygon expects 12 keys but got {}'.format(
          len(keys)))
    self._prefix = prefix
    self._keys = keys
    self._full_keys = [prefix + k for k in keys]
    super(slim_example_decoder.BoundingBox, self).__init__(self._full_keys)
  ...
  def __init__(self,
    ...
    self.keys_to_features = {
        ...
        'image/object/bbox/ymax':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y0':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x0':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y1':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x1':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y2':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x2':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y3':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x3':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y4':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x4':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/y5':
            tf.VarLenFeature(tf.float32),
        'image/object/polygon/x5':
            tf.VarLenFeature(tf.float32),
    ...
    self.items_to_handlers = {
        ...
        fields.InputDataFields.groundtruth_boxes: (
            slim_example_decoder.BoundingBox(['ymin', 'xmin', 'ymax', 'xmax'],
                                             'image/object/bbox/')),
        fields.InputDataFields.groundtruth_polygons: (
            Polygon(
                ['y0', 'x0', 'y1', 'x1', 'y2', 'x2', 'y3', 'x3', 'y4', 'x4', 'y5', 'x5'], 'image/object/polygon/')),
