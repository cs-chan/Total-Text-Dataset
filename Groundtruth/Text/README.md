...
a) ['.mat' Matlab format](http://www.cs-chan.com/source/ICDAR2017/groundtruth_text.zip). Can be load with Matlab, scipy.io.loadmat, etc..

b) ['.txt' format](http://www.cs-chan.com/source/ICDAR2017/txt_format.zip).
